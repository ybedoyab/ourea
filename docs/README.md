...
Ourea is adaptation investment decision intelligence under uncertainty for vulnerable urban hillsides.

This index is the entry point. The repository root keeps only `README.md`, `CHANGELOG.md` and standard project files.
...
- [Moravia case study](research/case-studies/moravia.md)

## Pilot

- [Six-month pilot](pilot/six-month-pilot.md)
- [Community co-design protocol](pilot/community-codesign-protocol.md)

## Competition

- [Submission draft](competition/submission-draft.md)
- [Deck outline](competition/deck-outline.md)
- [Demo script](competition/demo-script.md)
- [Final submission checklist](competition/final-submission-checklist.md)
- [Office hours brief](competition/office-hours-brief.md)
- [Judge Q&A](competition/judge-qa.md)

## Validation

- [QA report](validation/qa-report.md)
- [Final user checklist](validation/final-user-checklist.md)
- [Optimizer cross-check](validation/optimizer-crosscheck.md)
