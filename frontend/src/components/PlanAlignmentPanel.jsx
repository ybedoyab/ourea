  ...
  if (!entries.length) {
    return (
      <section data-testid="plan-alignment">
        <SectionHeading step={9} title="Comuna 8 plan alignment">
  ...
  return (
    <section data-testid="plan-alignment">
      ...
      <div className="alignment-list">
        {entries.map((entry) => (
          <article key={entry.id} className="alignment-card">
            ...
            <span>
              Maintenance: {entry.maintenance_responsible ?? 'not documented'}
            </span>
